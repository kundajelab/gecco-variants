...
def parse_args():
    ...
    parser.add_argument("--hdf_input",default="/srv/scratch/annashch/deeplearning/gecco/gc_corrected/classification/gecco.classificationlabels.SummitWithin200bpCenter.hdf5")
