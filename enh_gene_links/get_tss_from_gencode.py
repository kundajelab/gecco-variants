...
def main():
    ...
    minus_subset=minus_strand_genes[[0,'start_tss_region','end_tss_region','tss',8]]
    plus_subset=plus_strand_genes[[0,'start_tss_region','end_tss_region','tss',8]]
