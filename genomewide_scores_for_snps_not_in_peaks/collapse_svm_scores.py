...
import numpy as np 
import pandas as pd
data=pd.read_csv("gecco.snps.in.peaks.svm.scores.scaled.txt",header=0,sep='\t',index_col=0)
...
df.to_csv('gecco.snps.in.peaks.svm.delta.scores.txt',sep='\t',header=True,index=False)
