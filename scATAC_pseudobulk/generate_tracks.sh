prefix=/oak/stanford/groups/akundaje/projects/GECCO/scATAC/pseudobulk_pipeline_outputs/aggregate/
python generate_tracks.py --pval_bigwigs $prefix/pval.bigwig \
    --fc_bigwigs $prefix/fc.bigwig \
    --outf_fc_bigwig gecco_pseudobulk_fc_bigwig.json \
    --outf_pval_bigwig gecco_pseudobulk_pval_bigwig.json \
