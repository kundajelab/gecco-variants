...
python make_plots.py --tasks healthy tumor sw480 hct116 colo205 \
       --ref_files gkmexplain.dnase_c.diabetes.ref.txt gkmexplain.dnase_v.diabetes.ref.txt gkmexplain.sw480.diabetes.ref.txt gkmexplain.hct116.diabetes.ref.txt gkmexplain.colo205.diabetes.ref.txt \
       --alt_files gkmexplain.dnase_c.diabetes.alt.txt gkmexplain.dnase_v.diabetes.alt.txt gkmexplain.sw480.diabetes.alt.txt gkmexplain.hct116.diabetes.alt.txt gkmexplain.colo205.diabetes.alt.txt \
       --ylim 0.05
