import pandas as pd
import pdb
raw_scores=pd.read_csv("gecco.snps.alcohol.svm.scores.txt",header=0,sep='\t') 
...
raw_scores.to_csv('gecco.snps.alcohol.svm.scores.scaled.txt',index=True,header=True,sep='\t')
