import pysam
score_dict={}
prefix_ref="/oak/stanford/groups/akundaje/projects/GECCO/svm_score_and_interpret_ge_candidates/pred_ref"
prefix_alt="/oak/stanford/groups/akundaje/projects/GECCO/svm_score_and_interpret_ge_candidates/pred_alt"
...
for dataset in datasets:
    for split in range(0,10):
        ...
        for line in pred_ref:
            ...
            snp=tokens[0]
            chrom=snp.split('_')[0]
            pos=int(snp.split('_')[1])-1
            ref_snp_allele=snp.split('_')[3]
        ...
        for line in pred_alt:
            ...
            if ref_fasta_allele==ref_snp_allele:
                ...
                score_dict[snp][dataset]['ref']=svm_score
outf=open('gecco.snps.in.gxe.short.list.svm.scores.txt','w')
outf.write('#Chrom\t0pos\t1pos\trsid\tref\talt')
for dataset in datasets:
...
for snp in score_dict:
    ...
    ref=parts[3]
    alt=parts[4]
    outf.write(chrom+'\t'+str(pos0)+'\t'+str(pos1)+'\t'+rsid+'\t'+ref+'\t'+alt) 
    for dataset in datasets:
